...
export const roleMenus = {
    [ROLES.ADMIN]: [
        ...
        { path: "/restaurant-buffet", label: "Restaurant & Buffet", icon: "bi-cup-hot" },
    ...
    [ROLES.RECEPTIONIST]: [
        ...
        { path: "/customers", label: "Customer Management", icon: "bi-person-badge" },
        { path: "/booking-history", label: "Booking History", icon: "bi-clock-history" },
    ],
    [ROLES.RESTAURANT_MANAGER]: [
        { path: "/dashboard", label: "Dashboard", icon: "bi-speedometer2" },
        { path: "/menu-management", label: "Menu Management", icon: "bi-journal-richtext" },
        { path: "/buffet-management", label: "Buffet Management", icon: "bi-grid-3x3-gap" },
        { path: "/orders", label: "View Orders", icon: "bi-receipt" },
    ],
    [ROLES.EVENT_MANAGER]: [
        { path: "/dashboard", label: "Dashboard", icon: "bi-speedometer2" },
        { path: "/event-booking", label: "Event Booking", icon: "bi-calendar-check" },
