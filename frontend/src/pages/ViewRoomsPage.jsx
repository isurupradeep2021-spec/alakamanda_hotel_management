          ...
          return (
            <article className="room-catalog-card" key={room.id}>
              <div className="room-photo-wrap">
                <img
                  src={room.photoUrl || FALLBACK_IMAGE}
                  alt={`${room.roomType || 'Room'} ${room.roomNumber || ''}`}
                  className="room-photo"
                  loading="lazy"
                />
                <span className={`room-status-badge ${isBookable ? 'ok' : 'busy'}`}>
              ...
              <div className="room-content">
                ...
                <div className="room-meta">
                  <span><i className="bi bi-people" /> {room.capacity || '-'} Guests</span>
                  <span><i className="bi bi-cash" /> ${room.pricePerNight || '-'} / night</span>
                </div>
